                        ...
                        <div>
                            <div class="clearfix">
                                ...
                                <div style="padding-top:20px;">
                                    ...
                                    <div class="padding-top-10 clearfix">
                                        <span class="fl promotion-t margin-right-10">单品立减：</span>
                                        <div style="width: 250px" class="fl">
                                            <Input v-model="value4" placeholder="..." style="width: 100px"></Input> 元
...
export default {
    ...
    methods:{
        ...
        okAdd(){ //确认添加
            ...
            if(this.status == '新增'){
                this.$http.post('http://192.168.5.21:8080/store-promotion-info/add',{
                    ...
                    single_product_reduction:this.value4,
        ...
        btnAttr(index){
            ...
            this.value4 = this.orderData[index].single_product_reduction;

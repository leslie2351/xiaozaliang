                        ...
                        <div>
                            <div class="clearfix">
                                ...
                                <div style="padding-top:20px;">
                                    ...
                                    <div class="padding-top-10 clearfix">
                                        <span class="fl promotion-t margin-right-10">折扣：</span>
                                        <div style="width: 250px" class="fl">
                                            <Input v-model="value5" placeholder="..." style="width: 100px"></Input> 折
...
export default {
    ...
    methods:{
        ...
        okAdd(){ //确认添加
            ...
            if(this.status == '新增'){
                this.$http.post('http://192.168.5.21:8080/store-promotion-info/add',{
                    ...
                    discount_full_goods:this.value4,
                    discount_num:this.value5,
                    is_all : is_all,
                    ids:str,
                    promotion_type:3,
                }).then((data)=>{
        ...
        btnAttr(index){
            ...
            this.value4 = this.orderData[index].discount_full_goods;
            this.value5 = this.orderData[index].discount_num

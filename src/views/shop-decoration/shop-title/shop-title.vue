            ...
            <Modal
                ...
                <div>
                    <div class="padding-top-10 display">
                        <span class="fl label-t margin-right-10">标题：</span>
                        <Input v-model="value1" placeholder="..." style="width: 300px"></Input>
         
                    </div>
                    <div class="padding-top-10 display">
                        <span class="fl label-t margin-right-10">标题样式：</span>
...
export default {
    ...
    methods: {
        ...
        getSort(){ //获取最大值
            this.$http.post('http://192.168.10.108:8080/storeHomeTitle/queryMaxSort',{
                storeId:6666,
            })
            .then((data)=>{
                console.log(data);
        ...
        okAdd(){ //确认添加
            ...
            this.$http.post('http://192.168.10.108:8080/storeHomeTitle/insert',{
                storeId:6666,
                titleName:this.value1,
                titleStyleId:this.value2,
        ...
        btnAttr(index){
            ...
            this.value1 = this.orderData[index].titleName;
            this.value2 = this.orderData[index].titleStyleId;
        ...
        okAtter(){ //确认修改
            let isOpen = this.value5 == '是' ? 1:2
            this.$http.put('http://192.168.10.108:8080/storeHomeTitle/update',{
                id:this.ids,
                titleName:this.value1,
                titleStyleId:this.value2,
                relationType:this.dictCode,
        ...
        okDel (){ //点击删除确定时
            this.$http.post('http://192.168.10.108:8080/storeHomeTitle/delete',{
                id:this.ids,
        ...
        initTable(){ //初始化列表
            this.$http.post('http://192.168.10.108:8080/storeHomeTitle/selectAll',{

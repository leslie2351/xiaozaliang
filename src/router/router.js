...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'discountInfo/:order_id', title: '优惠券详情', name: 'discountInfo', component: () => import('@/views/advanced-router/component/discountInfo/discountInfo.vue') },
...
export const appRouter = [
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: '/promotion-management', title: '促销管理', name: 'promotion-management', component: () => import('@/views/promotion/promotion-management/promotion-management.vue') },
            { path: '/complimentary', title: '赠品管理', name: 'complimentary', component: () => import('@/views/promotion/complimentary/complimentary.vue') },
            { path: '/discount', title: '优惠券管理', name: 'discount', component: () => import('@/views/promotion/discount/discount.vue') },
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: '/shop-template', title: '店铺模板', name: 'shop-template', component: () => import('@/views/shop-decoration/shop-template/shop-template.vue') },
            { path: '/shop-banner', title: '店铺banner', name: 'shop-banner', component: () => import('@/views/shop-decoration/shop-banner/shop-banner.vue') },
            { path: '/shop-title', title: '店铺标题', name: 'shop-title', component: () => import('@/views/shop-decoration/shop-title/shop-title.vue') },
        ]
    },
];
